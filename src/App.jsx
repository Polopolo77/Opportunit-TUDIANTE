    ...
    <>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="hero grid md:grid-cols-2 items-center pt-10 xl:gap-0 gap-6 grid-cols-1" id="home">
          <div className="animate__animated animate__fadeInUp animate__delay-3s">
            <div className="flex items-center gap-3 mb-6 bg bg-zinc-800 w-fit p-4 rounded-2xl">
              ...
              <q>L'IA au service de votre croissance</q>
            </div>
            <h1 className="text-5xl font-bold mb-6">
              <ShinyText text="Hi I'm Paul-Emile" disabled={false} speed={3} className='custom-class' />
            </h1>
            <BlurText
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-10 pt-0 px-8" data-aos="fade-up" data-aos-duration="1000" data-aos-once="true">
            <div className="basis-full md:basis-7/12 pr-0 md:pr-8 border-b md:border-b-0 md:border-r border-violet-500/30">
              <div className="flex-1 text-left">
                ...
                <div className="flex flex-col sm:flex-row items-center sm:justify-between text-center sm:text-left gap-y-8 sm:gap-y-0 mb-4 w-full">
                  <div>
                    <h1 className="text-3xl md:text-4xl mb-1">
                      19<span className="text-violet-500">%</span>
                    </h1>
                    <p>CTR Meta Ads</p>
                  </div>
                  <div>
                    <h1 className="text-3xl md:text-4xl mb-1">
                      €0.08<span className="text-violet-500"> CPC</span>
                    </h1>
                    <p>Coût par clic</p>
                  </div>
                  <div data-aos="fade-up" data-aos-duration="1000" data-aos-delay="600" data-aos-once="true">
                    <h1 className="text-3xl md:text-4xl mb-1">
                      4<span className="text-violet-500"> piliers</span>
                    </h1>
                    <p>d'expertise</p>
                  </div>
                </div>
                ...
                <ShinyText
                  text="L'innovation IA au service de votre croissance."
                  disabled={false}
                  speed={3}
        ...
        <div className="tools mt-32">
          ...
          <p className="w-2/5 text-base/loose opacity-50" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="300" data-aos-once="true">Mes compétences techniques</p>
        ...
        <p className="text-base/loose text-center opacity-50" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="300" data-aos-once="true">Une sélection de projets qui reflètent mon expertise en IA appliquée au business.</p>
              ...
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <a href="mailto:contact@paul-emile.com" className="text-violet-400 hover:text-violet-300 transition-colors">contact@paul-emile.com</a>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  <span className="text-2xl">💼</span>
                  <div>
                    ...
                    <a href="https://linkedin.com/in/" target="_blank" rel="noopener noreferrer" className="text-violet-400 hover:text-violet-300 transition-colors">Voir mon profil</a>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  <span className="text-2xl">📍</span>
              ...
              >
                ...
                <div className="flex flex-col gap-6">
                  ...
                  <div className="text-center">
                    ...
                    >
                      <ShinyText text="Envoyer" disabled={false} speed={3} className="custom-class" />
                    </button>
                  </div>
                </div>
              </form>
