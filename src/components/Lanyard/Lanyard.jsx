...
const cardTexturePath = "/assets/card-face.png";
...
function Band({ maxSpeed = 50, minSpeed = 0 }) {
  ...
  // Le GLB utilise flipY=false (convention glTF)
        ...
        <RigidBody position={[2, 0, 0]} ref={card} {...segmentProps} type={dragged ? 'kinematicPosition' : 'dynamic'}>
          ...
          <group
            ...
            <mesh geometry={nodes.card.geometry}>
              <meshPhysicalMaterial map={cardFaceTexture} map-anisotropy={16} clearcoat={1} clearcoatRoughness={0.15} roughness={0.9} metalness={0.8} />
            </mesh>
