...
const Navbar = ({ hidden = false }) => {
  ...
  return (
    <nav className="navbar relative z-50 py-7 flex items-center justify-between px-6 md:px-12">
      ...
      >
        <li><a href="#home" className="sm:text-lg text-base font-medium">Accueil</a></li>
        <li><a href="#about" className="sm:text-lg text-base font-medium">À propos</a></li>
        <li><a href="#project" className="sm:text-lg text-base font-medium">Projets</a></li>
